...
#########################################################################
#									                                                      #
#        MySQL Performance Tuning Support Script                        #
#         This script takes information from "SHOW STATUS LIKE..."      #
#         and "SHOW VARIABLES LIKE..."  to produce sane recommendations # 
#         for tuning server variables.                                  #
#                                                                       #
#	Writen by: Shelton Reese <sjreese@aol.com>,                           #
#	Inspired by: db2ops.com                                 	            #
#	Version: 0.5M5		Released: 2018-01-22			                          #
...
#									                                                      #
#	Usage: ./mysql-tuning-support.sh [ mode ] 			                      #
#								                                                      	#
#	Available Modes: 					                                          	#
...
cecho "	-- MYSQL PERFORMANCE TUNING SUPPORT --" boldblue
cecho "	     - By: Shelton Reese -" black
